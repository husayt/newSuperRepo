            ...
            <div class="flex items-center mt-6">
              ...
              <div class="ml-3">
                <p class="text-sm font-medium leading-5 text-gray-900">
                  <a href="#" class="hover:underline">{{ prop.listingType }}</a>
                </p>
...
<script>
//
import { defineComponent, computed, watch, ref, unref, toRaw } from "vue"
...
export default defineComponent({
  async setup() {
    ...
    console.log(unref(toRaw(properties.value)))
